...
<head>
    ...
    <title>Examination Grading and management System</title>
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="Post" Action="">
                            <?php echo $errorMsg; ?>
                               <strong><h2 align="center">Admin Login</h2></strong><hr>
                        ...
                        <button type="submit" style="background-color:black" name="login" class="btn btn-success btn-flat m-b-30 m-t-30">Log in</button>
